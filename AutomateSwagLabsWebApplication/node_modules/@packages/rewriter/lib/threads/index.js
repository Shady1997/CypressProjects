...
const _debugWorker = !debug.enabled ? lodash_1.default.noop : (worker) => {
    return Object.assign(Object.assign({}, lodash_1.default.pick(worker, 'isBusy', 'id')), { freeWorkers: lodash_1.default.filter(workers, { isBusy: false }).length });
};
const _debugOpts = !debug.enabled ? lodash_1.default.noop : (opts) => {
    return Object.assign(Object.assign({}, lodash_1.default.pick(opts, 'isHtml')), { sourceLength: opts.source.length });
};
...
function wrapProcessExit() {
    ...
    // @ts-ignore
    process.exit = lodash_1.default.once((...args) => __awaiter(this, void 0, void 0, function* () {
...
function sendRewrite(worker, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const req = Object.assign({ port: port1 }, lodash_1.default.omit(opts, 'deferSourceMapRewrite'));
