...
const studio = (0, tslib_1.__importStar)(require("./studio"));
...
class SocketE2E extends socket_base_1.SocketBase {
    ...
    watchTestFileByPath(config, specConfig) {
        ...
        const cleanIntegrationPrefix = (s) => {
            const removedIntegrationPrefix = path_1.default.join(config.integrationFolder, s.replace(`integration${path_1.default.sep}`, ''));
            return path_1.default.relative(config.projectRoot, removedIntegrationPrefix);
        };
        ...
        return preprocessor_1.default.getFile(filePath, config)
