...
exports.open = exports._createDetachedInstance = void 0;
...
const browsers_1 = require("../../../launcher/lib/browsers");
const firefox_profile_1 = (0, tslib_1.__importDefault)(require("firefox-profile"));
const firefox_util_1 = (0, tslib_1.__importDefault)(require("./firefox-util"));
const utils_1 = (0, tslib_1.__importDefault)(require("./utils"));
const launcherDebug = (0, tslib_1.__importStar)(require("../../../launcher/lib/log"));
const events_1 = require("events");
const os_1 = (0, tslib_1.__importDefault)(require("os"));
const tree_kill_1 = (0, tslib_1.__importDefault)(require("tree-kill"));
const mime_db_1 = (0, tslib_1.__importDefault)(require("mime-db"));
...
function open(browser, url, options = {}, automation) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        let remotePort;
        if (hasCdp) {
            remotePort = yield (0, protocol_1.getRemoteDebuggingPort)();
        ...
        const [foxdriverPort, marionettePort,] = yield bluebird_1.default.all([(0, get_port_1.default)(), (0, get_port_1.default)()]);
        ...
        const [cacheDir, extensionDest, launchOptions,] = yield bluebird_1.default.all([
        ...
        if (!(yield fs_extra_1.default.pathExists(xulStorePath))) {
            ...
            yield fs_extra_1.default.writeJSON(xulStorePath, { 'chrome://browser/content/browser.xhtml': { 'main-window': { 'width': 1280, 'height': 1024, sizemode } } });
        }
        ...
        if (!(yield fs_extra_1.default.pathExists(path_1.default.join(userCSSPath, 'userChrome.css')))) {
            try {
                yield fs_extra_1.default.mkdir(userCSSPath);
            }
            catch (_a) {
            ...
            yield fs_extra_1.default.writeFile(path_1.default.join(profileDir, 'chrome', 'userChrome.css'), userCss);
        }
        ...
        const browserInstance = yield (0, browsers_1.launch)(browser, 'about:blank', launchOptions.args, {
        ...
        try {
            yield firefox_util_1.default.setup({ automation, extensions: launchOptions.extensions, url, foxdriverPort, marionettePort, remotePort, onError: options.onError });
        }
        catch (err) {
