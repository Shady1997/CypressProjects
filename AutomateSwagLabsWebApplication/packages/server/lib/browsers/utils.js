...
const ensureCleanCache = function (browser, isTextTerminal) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        yield fs.removeAsync(p);
        yield fs.ensureDirAsync(p);
        return p;
    });
};
...
function executeBeforeBrowserLaunch(browser, launchOptions, options) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        if (plugins_1.default.has('before:browser:launch')) {
            const pluginConfigResult = yield plugins_1.default.execute('before:browser:launch', browser, launchOptions);
