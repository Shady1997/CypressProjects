...
const debug = (0, debug_1.default)('cypress:server:stream_buffer');
function streamBuffer(initialSize = 2048) {
    ...
    class StreamBuffer extends stream_1.default.Writable {
        constructor() {
            super(...arguments);
            this.readers = [];
        }
        createReadStream() {
            let bytesRead = 0;
            const readerId = lodash_1.default.uniqueId('reader');
            const onRead = (size) => {
                if (!buffer) {
