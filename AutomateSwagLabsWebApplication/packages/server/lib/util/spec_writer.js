...
const recast = (0, tslib_1.__importStar)(require("recast"));
...
const updateRunnableExpression = ({ fileDetails, absoluteFile, runnableTitle }, fnNames, cb) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    ...
    if (fileDetails && fileDetails.absoluteFile) {
        const fileDetailsAst = yield getAst(fileDetails.absoluteFile);
    ...
    const runnableTitleAst = yield getAst(absoluteFile);
...
const appendCommandsToTest = (saveDetails) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
